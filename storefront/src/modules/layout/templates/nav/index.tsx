      ...
      <header className="relative h-24 mx-auto duration-200 bg-white shadow-sm">
        <nav className="content-container mx-auto flex items-center justify-between w-full h-full text-sm font-semibold px-8">
          ...
          <div className="items-center h-full hidden lg:flex gap-8 text-brand-dark font-bold uppercase">
            <LocalizedClientLink href="/" className="text-brand-green">Home</LocalizedClientLink>
            <LocalizedClientLink href="/store" className="hover:text-brand-green transition-colors">Shop</LocalizedClientLink>
          ...
          <div className="flex items-center gap-x-6 h-full flex-1 basis-0 justify-end">
            <div className="relative hidden xl:block w-48">
              <input type="text" placeholder="Search..." className="w-full bg-brand-light rounded-full py-2 px-4 text-sm font-normal focus:outline-none focus:ring-1 focus:ring-brand-green" />
              <svg className="absolute right-3 top-2.5 text-gray-400 w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8" /><path d="M21 21l-4.35-4.35" /></svg>
            </div>
            ...
            <div className="flex items-center gap-5 text-brand-dark">
              ...
              <div className="relative cursor-pointer hover:text-brand-green">
                ...
                <span className="absolute -top-2 -right-2 bg-brand-red text-white text-[10px] w-4 h-4 flex items-center justify-center rounded-full">12</span>
              </div>
