...
export default function QuickAddToCart({ variantId, productHandle, productId }: QuickAddProps) {
    ...
    return (
        <>
            {/* Wishlist heart button — always visible in top-right corner */}
            <button
            ...
            <div className="absolute bottom-0 left-0 w-full translate-y-full group-hover:translate-y-0 transition-transform duration-300 opacity-0 group-hover:opacity-100 z-10 flex">
                ...
                <button
                    ...
                    disabled={isAdding}
                    className={`flex-1 flex items-center justify-center gap-2 py-3 text-white text-sm font-bold uppercase tracking-wider transition-colors ${added
                            ? "bg-emerald-600"
                            : isAdding
